...
# 4. REGRESSION ANALYSIS FOR READ OF A MODIFIED FRYER & LEVITT (2004) APPROACH MATH (part 2 - part 6)
# 5. REGRESSION ANALYSIS FOR READ OF A MODIFIED FRYER & LEVITT (2004) APPROACH READING 
##################################################################################
...
############################### 5.2.9 Non-rotated & PART 3 rotated questions #############################
...
save(DEVCON8s, file = "C:/Users/WB484284/Desktop/PISAlatestversions/RFiles/PISA_2012/DEVCON8s.rda") 

# First, remember, we have a smaller data set (16760 data points) compared to when we first regressed the Vietnam PISA Math score
